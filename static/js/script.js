$(document).ready(function() {
    ...
    $("#add_ingredient").on("click", function() {
        $(".new-ingredient").first().children(".input-field:last").clone().insertAfter(".new-ingredient .input-field:last").find("input[type='text'], select, textarea").val("");
        ingredientField += 1;
    });
    $("#remove_ingredient").on("click", function() {
        if (ingredientField > 1) {
            // only remove the :last item
            $(this).siblings(".ingredient").last().children(".input-field:last").remove();
    ...
    $("#add_step").on("click", function() {
        $(".new-step").first().children(".input-field:last").clone().insertAfter(".new-step .input-field:last").find("input[type='text'], select, textarea").val("");
